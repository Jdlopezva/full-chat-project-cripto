...
class NotificationService {
  ...
  Each device has a token, we will get this token so that we know which device 
  ...
  */
  ...
  we don't want to be still sending notifications to the device. When any user
  logs back in, the new device token will be saved.
